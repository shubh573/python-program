...
plt.title('Number of players representing a particular country')
#plt.show(sns)

plt.figure(figsize=(15,6))
sns.countplot(x="Age",data=df)
plt.title('Visualization with the player’s age')
#plt.show(sns)
#-----------------------------------------------------
...
plt.title('Best Goal Keeper:Shot Stopper')
...
plt.title('Best Goal Keeper:Sweeper')
...
plt.title('Best Defender:LEFT CENTRAL DEFENDER')
...
plt.title('Best Defender:RIGHT CENTRAL DEFENDER')
...
plt.title('Best Defender:LEFT WING BACK')
...
plt.title('Best Defender:RIGHT WING BACK')
...
plt.title('Best Mid-Fielders:PLAYMAKER')
...
plt.title('Best Mid-Fielders:Beast')
...
plt.title('Best Mid-Fielders:Controller')
...
plt.title('Best Attackers:Attacking Left Wing')
...
plt.title('Best Attackers:Attacking Right Wing')
...
plt.ylabel("Striker")
plt.title('Best Attackers:STRIKER')
